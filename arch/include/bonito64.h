...
/* MIPS Technologies, Inc. has made modifications to the
 * original Algorithmics Ltd. version of this file.  Use of the MIPS
 * Technologies modifications is subject to the MIPS Technologies Yamon
...
#define BONITO_SDCFG_DRAMRFSHMULT       0xfc000000 /* Added by MIPS */
#define BONITO_SDCFG_DRAMRFSHMULT_SHIFT 26	   /* Added by MIPS */
...
#define BONITO_BUILDINFO_DATA_MASK	0x000000ff
#define BONITO_BUILDINFO_DATA_MASK_SHIFT	 0
#define BONITO_BUILDINFO_ADDR_MASK	0x00001f00
#define BONITO_BUILDINFO_ADDR_MASK_SHIFT	 8

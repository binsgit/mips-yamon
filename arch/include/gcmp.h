/*
 * Multiprocessor Sub-system Global Control
 *
...
#define GCMP_GDB_OFS		0x6000 /* Global Debug Block */
...
#define GCMPGCB(gcmp,reg)	REGP(KSEG1(gcmp), GCMPGCBOFS(reg))
#define GCMPCLCB(gcmp,reg)	REGP(KSEG1(gcmp), GCMPCLCBOFS(reg))
#define GCMPCOCB(gcmp,reg)	REGP(KSEG1(gcmp), GCMPCOCBOFS(reg))
#define GCMPGDB(gcmp,reg)	REGP(KSEG1(gcmp), GCMPGDBOFS(reg))

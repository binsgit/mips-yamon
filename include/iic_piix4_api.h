...
#ifndef IIC_PIIX4_API_H
#define IIC_PIIX4_API_H
 ...
 *      interface for the PIIX4 IIC device driver. The
 ...
 *
 *        1) iic_piix4_install: installs the 'IIC' device driver

#ifndef LAN_SAA9730_API_H
#define LAN_SAA9730_API_H

/************************************************************************
 *
 *      LAN_SAA9730_api.h
 *
 *      The 'LAN_SAA9730_api' module defines the specific public
 *      interface for the SAA9730 LAN device driver. The
 *      generic LAN device driver interface is defined in the
 *      'lan_api' module, which is supported by this driver.
 *
 *      The specific public interface comprise:
 *
 *        1) LAN_SAA9730_install: installs the 'LAN' device driver
 ...
 *  -------------
 *
 *  Installs the LAN SAA9730 device drivers services in 
...
#endif /* #ifndef LAN_SAA9730_API_H */

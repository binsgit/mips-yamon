#ifndef EEPROM_IIC_API_H
#define EEPROM_IIC_API_H

/************************************************************************
 *
 *      EEPROM_IIC_api.h
 *
 *      The 'EEPROM_IIC_api' module defines the specific public
 *      interface for the EEPROM device driver with IIC bus interface.
 *      The generic EEPROM device driver interface is defined in the
 *      'eeprom_api' module, which is supported by this driver.
 *
 *      The specific public interface comprise:
 *
 *        1) EEPROM_IIC_install: installs the 'EEPROM' device driver
 ...
 *  -------------
 *
 *  Installs the EEPROM device drivers services in 
